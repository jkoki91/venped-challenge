...
function SearchForm({ placeholder, handlerSearch }) {

  return (
    <form className="relative" onSubmit={handlerSearch}>
      <label htmlFor="action-search" className="sr-only">Search</label>
      <input id="action-search" className="form-input pl-9 focus:border-slate-300" type="search" name='search' placeholder={placeholder} />
